...
fn router() -> Result<(), anyhow::Error> {
    ...
    phy2.write(&[Frame::new(mac1, mac2, et, b"the muffin man?")])?;
    phy1.write(&[Frame::new(mac2, mac1, et, b"the muffin man!")])?;
    phy2.write(&[
        Frame::new(mac1, mac2, et, b"why yes"),
        Frame::new(mac1, mac2, et, b"i know the muffin man"),
        Frame::new(mac1, mac2, et, b"the muffin man is me!!!"),
    ])?;
